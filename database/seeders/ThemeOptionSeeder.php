    ...
    public function run()
    {
        ...
        $data = [
            'en_US' => [
                [
                    'key'   => 'site_title',
                    'value' => 'Just another Platform CMS site',
                ],
                [
                    'key'   => 'copyright',
                    'value' => '©' . now()->format('Y') . ' Platform Technologies. All right reserved.',
                ],
                [
                    'key'   => 'favicon',
                ...
                [
                    ...
                    'value' => 'With experience, we make sure to get every project done very fast and in time with high quality using our Platform CMS https://1.envato.market/LWRBY',
                ],
                [
                    'key'   => 'phone',
                    'value' => '+(123) 345-6789',
            ...
            'vi' => [
                [
                    'key'   => 'site_title',
                    'value' => 'Một trang web sử dụng Platform CMS',
                ],
                [
                    'key'   => 'copyright',
                    'value' => '©' . now()->format('Y') . ' Platform Technologies. Tất cả quyền đã được bảo hộ.',
                ],
                [
                    'key'   => 'favicon',
                    'value' => 'general/favicon.png',
                ...
                [
                    'key'   => 'site_description',
                    'value' => 'Với kinh nghiệm dồi dào, chúng tôi đảm bảo hoàn thành mọi dự án rất nhanh và đúng thời gian với chất lượng cao sử dụng Platform CMS của chúng tôi https://1.envato.market/LWRBY',
                ],
                [
                    'key'   => 'phone',
                    'value' => '+(123) 345-6789',
