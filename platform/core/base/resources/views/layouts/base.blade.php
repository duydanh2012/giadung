...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family={{ urlencode(theme_option('admin_primary_font', 'Ubuntu')) }}:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">

    <style>
        :root {
            --primary-font: '{{ theme_option('admin_primary_font', 'Ubuntu') }}', sans-serif;
        }
    </style>
...
<body @if (BaseHelper::adminLanguageDirection() == 'rtl') dir="rtl" @endif class="@yield('body-class', 'page-sidebar-closed-hide-logo page-content-white page-container-bg-solid') {{ session()->get('admin-sidebar') ? 'page-sidebar-closed' : '' }}" style="@yield('body-style')">
