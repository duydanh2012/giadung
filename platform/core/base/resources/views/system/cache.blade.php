        ...
        <div class="widget-body">
            <table class="table table-bordered vertical-middle table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            {{ trans('core/base::cache.commands.generate_route.description') }}
                        </td>
                        <td>
                            <button class="btn green-meadow btn-block btn-clear-cache" data-type="generate_route" data-url="{{ route('system.cache.clear') }}">
                                {{ trans('core/base::cache.commands.generate_route.title') }}
                            </button>
                        </td>
                    </tr>
                </tbody>
