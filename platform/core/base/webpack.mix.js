...
mix.webpackConfig({
    resolve: {
        alias: {
            ziggy: path.resolve(source + '/resources/assets/js/ziggy/route.dev.js'),
        },
    },
});

mix
    .js(source + '/resources/assets/js/ziggy/ziggy.js', dist + '/js/ziggy.js')
    .js(source + '/resources/assets/js/ziggy/admin.js', dist + '/js/route.js')
    .copy(dist + '/js/route.js', source + '/public/js');
