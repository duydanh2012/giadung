@if ($shortCode->image && $shortCode->video)
<!-- video home -->
<div class="wrapVideoHome">
    <div class="container-xl containerVideoHome">
        <div class="contentVideoHome">
            <div class="wrapBannerVideoHome" data-src="{{ $shortCode->video }}">
                <img src="{{ RvMedia::getImageUrl($shortCode->image) }}" class="imgVideoHome" alt="Banner" />
